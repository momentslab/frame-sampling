...
def get_config(parse=True, **optional_kwargs):
    ...
    parser.add_argument('--file_path', type=str, default='./src/video_model_research/CSTA//SumMe/Jumps.mp4')
    parser.add_argument('--dir_path', type=str, default='./src/video_model_research/CSTA//SumMe')
    parser.add_argument('--ext', type=str, default='mp4')
    parser.add_argument('--sample_rate', type=int, default=1)
    parser.add_argument('--save_path', type=str, default='./src/video_model_research/CSTA//summary_videos')
    parser.add_argument('--weight_path', type=str, default='./src/video_model_research/CSTA//weights/SumMe/split4.pt')

    if parse:
        kwargs = vars(parser.parse_args())
    else:
        kwargs = {arg.dest: optional_kwargs.get(arg.dest, arg.default)
