...
class Qwen2(VideoModel):
    ...
    def _setup_model(self):
        ...
        if torch.cuda.is_available():
            torch.backends.cuda.enable_flash_sdp(True)  # Enable flash attention optimization
